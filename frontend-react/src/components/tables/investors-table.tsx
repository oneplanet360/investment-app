                ...
                data.map((investor) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-center">
                      <span
                        className={`text-xs px-2.5 py-0.5 rounded-full capitalize font-medium border ${kycStyle[investor.kycStatus] || ""}`}
                      >
                        {investor.kycStatus}
                      </span>
                    </td>
                    <td className="px-5 py-3.5 text-xs text-gray-600 whitespace-nowrap">
                      ...
                      <p className="text-gray-400">
                        {timeAgo(investor.createdAt)}
                      </p>
                    </td>
                    <td className="px-5 py-3.5 text-center">
                      <Link
                        to={`/admin/investors/${investor.username}`}
