...
import type { INominee } from "../../services/admin/adminNominee/adminNominee.types";
          ...
          <table className="w-full text-sm min-w-187.5">
            <thead>
              <tr className="bg-indigo-600 text-white">
                ...
                <th className="text-left px-5 py-3 font-medium">Nominee Name</th>
                <th className="text-left px-5 py-3 font-medium">Relation</th>
                ...
                data.map((k) => {
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5">
                        <p className="text-sm text-gray-700">{k.nomineeName}</p>
                      </td>
                      <td className="px-5 py-3.5">
                        <p className="text-sm text-gray-700">{k.relation}</p>
                      </td>
