...
import { useUpdateAdminProfileMutation } from "../../services/admin/adminProfile/adminProfile.mutation";
import type { AdminProfilePayload } from "../../services/admin/adminProfile/adminProfile.types";
