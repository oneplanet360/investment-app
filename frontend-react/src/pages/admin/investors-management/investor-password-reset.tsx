...
import { useResetInvestorPasswordMutation } from "../../../services/admin/adminInvestors/adminInvestors.mutation";
...
export default function InvestorResetPassword() {
  ...
  const { data, isLoading: isSearching } = useInvestorsQuery(
    1,
    5,
    debouncedQuery,
  );
  ...
  const { mutate: resetPassword, isPending } =
    useResetInvestorPasswordMutation();
