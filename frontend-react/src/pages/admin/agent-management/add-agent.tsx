...
export default function AddAgent() {
  ...
  const inputCls = (error?: string) =>
    `w-full border rounded px-3 py-2 text-sm outline-none transition-colors ${
      error
        ? "border-red-500"
        : "border-gray-200 focus:border-indigo-400 bg-white text-gray-700"
    }`;
  ...
  return (
    <div className="min-h-full bg-[var(--theme-bg)] p-4 sm:p-6">
      ...
      <form
        ...
        className="bg-white rounded-lg shadow-sm p-5 sm:p-6 space-y-5"
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="text"
              {...register("mobile")}
              className={inputCls(errors.mobile?.message)}
            />
          </div>
          ...
          <div>
            ...
            <input
              type="text"
              {...register("referredBy")}
              className={inputCls(errors.referredBy?.message)}
