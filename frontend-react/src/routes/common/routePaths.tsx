...
import { AUTH_ROUTES, PROTECTED_ROUTES, AGENT_PROTECTED_ROUTES, INVESTOR_PROTECTED_ROUTES } from './routes';
...
// Client (Agent) Pages
const ClientAgentDashboard = lazy(() => import('../../pages/client/agent/dashboard'));
const ClientAgentAddInvestor = lazy(() => import('../../pages/client/agent/add-investor'));
const ClientAgentAllInvestors = lazy(() => import('../../pages/client/agent/all-investors'));
const ClientAgentCommissions = lazy(() => import('../../pages/client/agent/commissions'));
const ClientAgentTeam = lazy(() => import('../../pages/client/agent/team'));
const ClientAgentWallet = lazy(() => import('../../pages/client/agent/wallet'));
const ClientAgentWithdrawals = lazy(() => import('../../pages/client/agent/withdrawals'));

// Client (Investor) Pages
const ClientInvestorDashboard = lazy(() => import('../../pages/client/investor/dashboard'));
const ClientInvestorInvestments = lazy(() => import('../../pages/client/investor/investments'));
const ClientInvestorKyc = lazy(() => import('../../pages/client/investor/kyc'));
const ClientInvestorRoiHistory = lazy(() => import('../../pages/client/investor/roi-history'));
const ClientInvestorTopUps = lazy(() => import('../../pages/client/investor/top-ups'));
const ClientInvestorWallet = lazy(() => import('../../pages/client/investor/wallet'));
const ClientInvestorWithdrawals = lazy(() => import('../../pages/client/investor/withdrawals'));
...
export const agentProtectedRoutesPaths = [
  ...
  { path: AGENT_PROTECTED_ROUTES.ADD_INVESTOR, element: <ClientAgentAddInvestor /> },
  { path: AGENT_PROTECTED_ROUTES.ALL_INVESTORS, element: <ClientAgentAllInvestors /> },
  { path: AGENT_PROTECTED_ROUTES.COMMISSIONS, element: <ClientAgentCommissions /> },
  { path: AGENT_PROTECTED_ROUTES.TEAM, element: <ClientAgentTeam /> },
  { path: AGENT_PROTECTED_ROUTES.WALLET, element: <ClientAgentWallet /> },
  { path: AGENT_PROTECTED_ROUTES.WITHDRAWALS, element: <ClientAgentWithdrawals /> },
];

export const investorProtectedRoutesPaths = [
  { path: INVESTOR_PROTECTED_ROUTES.DASHBOARD, element: <ClientInvestorDashboard /> },
  { path: INVESTOR_PROTECTED_ROUTES.INVESTMENTS, element: <ClientInvestorInvestments /> },
  { path: INVESTOR_PROTECTED_ROUTES.KYC, element: <ClientInvestorKyc /> },
  { path: INVESTOR_PROTECTED_ROUTES.ROI_HISTORY, element: <ClientInvestorRoiHistory /> },
  { path: INVESTOR_PROTECTED_ROUTES.TOP_UPS, element: <ClientInvestorTopUps /> },
  { path: INVESTOR_PROTECTED_ROUTES.WALLET, element: <ClientInvestorWallet /> },
  { path: INVESTOR_PROTECTED_ROUTES.WITHDRAWALS, element: <ClientInvestorWithdrawals /> },
];