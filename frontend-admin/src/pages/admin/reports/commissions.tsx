import { useAdminCommissionReport } from "../../../services/adminReports/adminReports.query";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-lg shadow-sm p-5">
          ...
          <div className="space-y-2">
            {topEarningAgents.length === 0 ? <p className="text-sm text-gray-500">No data available</p> : null}
