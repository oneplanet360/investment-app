      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="bg-white rounded-lg shadow-sm p-5">
          ...
          <Row
            label="Status"
            value={
              <span className={`text-xs px-2.5 py-0.5 rounded-full capitalize font-medium ${statusStyle[w.status]}`}>
                {w.status}
              </span>
            }
          />
          ...
          <Row
            ...
            value={
              <span className="text-orange-500 font-semibold">
                ${w.charge.toLocaleString("en-US", { minimumFractionDigits: 2 })} USD
              </span>
            }
          />
          <Row
        ...
        <div className="bg-white rounded-lg shadow-sm p-5">
          ...
          <Row label="Rate" value={`$1.00 USD = ${w.conversionRate.toFixed(2)} ${w.conversionCurrency}`} />
          <Row
